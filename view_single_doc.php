<?php
  ...
  include 'classes/view_doctor_one.classes.php';
...
<body>
  ...
  <div class="app-main">
    <div class="main-header-line">
      <h1 style="color: black;">Doctor's Profile!</h1>
  ...
  <div class="container my-4">
        <div class="row">
            <div class="col-md-3">
                <img src="doctors_images/<?php echo $user['doctor_img_path']?>" class="rounded float-start img-fluid" style="height: 30vh;" alt="Passport">
            </div>
            <div class="col-md-8 flex" style="display: flex;">
                <div class="mb-4">
                     <?php if ($user): ?>
                      <h4><?php echo htmlspecialchars($user['sname']) . ' ' . htmlspecialchars($user['oname']) . ' ' . htmlspecialchars($user['fname']); ?></h4>
                      <p>Email: <?php echo htmlspecialchars($user['email']); ?></p>
                      <p>Phone Number: <?php echo htmlspecialchars($user['phone']); ?></p>
                      <p>Speciality: <?php echo htmlspecialchars($user['special']); ?></p>
                      <p>Gender: <?php echo htmlspecialchars($user['gender']); ?></p>
                      <p>Date of Birth: <?php echo htmlspecialchars($user['dob']); ?></p>
                      <p>State of origin: <?php echo htmlspecialchars($user['state']); ?></p>
                  <?php else: ?>
