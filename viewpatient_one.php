<?php
  ...
  include 'classes/view_p.classes.php';
...
<body>
  ...
  <div class="app-main">
    <div class="main-header-line">
      <h1 style="color: black;">Patient's Profile!</h1>
  ...
  <div class="container my-4">
        <div class="row">
            <div class="col-md-3">
                <img src="https://th.bing.com/th/id/OIP.KgxWIJeuFzqf6EWcmhpp6AHaHa?w=512&h=512&rs=1&pid=ImgDetMain" class="rounded float-start img-fluid" style="height: 30vh;" alt="Passport">
            </div>
            <div class="col-md-8 flex" style="display: flex;">
                <div class="mb-4">
                  <?php if (!empty($users)): ?>
                     <?php foreach ($users as $user): ?>
                      <h4><?php echo htmlspecialchars($user['sname']) . " " . htmlspecialchars($user['fname']); ?></h4>
                      <p>Patients ID: <?php echo htmlspecialchars($user['patientid']); ?></p>
                      ...
                      <hr>
                        <a href="ecounter_p.php?patientid=<?php echo $user['patientid']?>" >
                      <button>Patients Ecounter Note (History)</button>
                      </a>
                          <?php endforeach; ?>
                      <?php else: ?>
                          <p><?php echo htmlspecialchars($error ?: 'No users found.'); ?></p>
                      <?php endif; ?>
