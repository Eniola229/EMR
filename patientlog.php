...
<html lang="en">
  ...
  <div class="d-md-flex half">
    <div class="bg" style="background-image: url('https://www.rccghealthcentre.com/assets/images/02.jpg');"></div>
    <div class="contents">
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            <div class="form-block mx-auto">
              ...
              if (isset($_GET['status'])) {
                  ...
                  switch ($errorCode) {
                      ...
                      case 'invalid_attempt':
                          ...
                          break;
                      case 'user_deleted':
                           echo '<p style="color:red; text-align:center">You deleted a Member. Login Again!</p>';
                          break;
                      default:
              ...
              <form action="includes/patient1login.inc.php" method="POST">
