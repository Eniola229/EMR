<?php
session_start();
  include "classes/view_doctor.classes.php";
...
<body>
  ...
  <div class="app-main">
    <div class="main-header-line">
      <h1 style="color: black;">Welcome <?php echo $_SESSION['fname'] ?>!</h1>
      ...
      <div class="chart-container-wrapper big">
        <div class="chart-container">
          <div class="chart-container-header">
            <h2>Search For Doctors Or Nurse</h2>
            <span>Kindly enter the Doctor or Nurse first name</span>
          </div>
       ...
       <script>
            ...
            $('#search').on('keyup', function(){
                var query = $(this).val();
                $.ajax({
                    url: 'classes/search.classes.php',
                    type: 'GET',
       ...
       <!----------This is for Records-------->
  <div class="container mt-5">
    <h2 class="mb-4">Doctors and Nurse</h2>
    <table class="table">
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr class="table-primary">
          <th scope="row"><img style="height: 20vh; widows: 200px;" src="doctors_images/<?php echo $user_all['doctor_img_path'] ?>" class="img-thumbnail" alt="..."></th>
          <th scope="row"><?php echo $user_all['user_id']; ?></th>
          <th scope="row"><?php echo $user_all['sname']; ?></th>
          <th scope="row"><?php echo $user_all['fname']; ?></th>
          <th scope="row"><?php echo $user_all['email']; ?></th>
          <th scope="row"><?php echo $user_all['gender']; ?></th>
          
          <td>
            <a href="view_single_doc.php?id=<?php echo $user_all['user_id'] ?>">
