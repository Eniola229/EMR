<?php
  ...
  include "classes/viewpatients.classes.php";
...
<body>
  ...
  <div class="app-left">
    ...
    <div class="app-logo">
      ...
      <li class="nav-list-item">
        <a class="nav-list-link" href="allpatient.php">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"/><polyline points="13 2 13 9 20 9"/></svg>
          View All Patients
        </a>
      </li>
      ...
      <div class="chart-container-wrapper big">
        <div class="chart-container">
          <div class="chart-container-header">
            ...
            <span>Kindly enter the Doctor first name</span>
          </div>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr class="table-primary">
          ...
          <th scope="row"><?php echo $user['dname'] ?></th>
          <th scope="row"><?php echo $user['chronic_pc'] ?></th>
          <td>
            <a href="view_complains.php?id=<?php echo $user['user_id']?>" >
