...
class Login extends Dbh
{
    ...
    {
        try {
            $stmt = $this->connect()->prepare('SELECT * FROM doctor WHERE email = ?;');
            ...
            $_SESSION['doctor_img_path'] = $user['doctor_img_path'];
            $_SESSION['fname'] = $user['fname'];
            $_SESSION['sname'] = $user['sname'];
            $_SESSION['email'] = $user['email'];
            $_SESSION['phone'] = $user['phone'];
            $_SESSION['doctors_img'] = $user['doctors_img'];
            $_SESSION['special'] = $user['special'];
            $_SESSION['qua'] = $user['qua'];
